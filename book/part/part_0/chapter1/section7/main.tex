...
Ésta es la fase a la que dedicaremos el 80\% del tiempo total invertido en 
la resolución de calquier problema basado en datos.

\begin{enumerate}
    \item \textbf{Limpieza de datos:} Lso siguientes recuros pueden esclarecer de que setrata esta etapa en los datos.

    \begin{enumerate}
        \item \href{https://support.microsoft.com/en-us/office/top-ten-ways-to-clean-your-data-2844b620-6f7c-47a7-acfe-c11927a07ped}{Microsoft}
        \item \href{https://www.ibm.com/mx-es/think/topics/data-cleaning}{IBM}
        \item \href{https://aws.amazon.com/es/what-is/data-cleansing/}{AWS}
    \end{enumerate}
\end{enumerate}
